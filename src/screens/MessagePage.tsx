...
import {FlatList, StyleSheet, View, ImageBackground, Text, TouchableHighlight} from 'react-native';
import {
  Container,
  Card,
  UserInfo,
...
const Messages = [
{
    ...
    messageText: 'Hello, Good morning! I would like to set an appointment for my dog today.',
    // messageStatus: 'read',
    // messageCount: 2,
    // isOnline: true,
},
